...
def registerUser(request):
    if request.user.is_authenticated:
        ...
        if form.is_valid():
            ...
            user.role = User.CUSTOMER
            user.save()
            messages.success(request, 'Your account bas been registered sucessfully!')
...
def registerVendor(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and vendor_form.is_valid():
            ...
            vendor.save()
            messages.success(request, 'Your account bas been registered sucessfully! Please wait for the approval.')
